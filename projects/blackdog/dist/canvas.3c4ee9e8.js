    ...
    "js/canvas.js": [
      function(require, module, exports) {
        ...
        function Enemy(x, y, img, width, height) {
          ...
          this.update = function(enemies) {
            ...
            for (var i = 0; i < enemies.length; i++) {
              ...
              if (
                distance(_this.x, _this.y, enemies[i].x, enemies[i].y) - 20 <
                0
              ) {
                // HITBOX ^^^
              ...
              if (
                distance(player.x, player.y, enemies[i].x, enemies[i].y) - 20 <
                0
              ) {
        ...
        function init() {
          ...
          var sx = randomIntFromRange(
            window.innerWidth + 50 - window.innerWidth,
            window.innerWidth - 50
          );
          var sy = randomIntFromRange(
            window.innerHeight + 50 - window.innerHeight,
            window.innerHeight - 50
          ); // instantiate coin
          ...
          for (var i = 0; i < 3; i++) {
            ...
            enemies.push(
              new Enemy(_x, _y, document.getElementById("enemy"), 30, 30)
            );
          }
        } //// ANIMATION LOOP
        ...
        function animate() {
          ...
          if (distance(player.x, player.y, coin.x, coin.y) < 25) {
            ...
            enemies.push(
              new Enemy(x, y, document.getElementById("enemy"), 30, 30)
            );
